...
<!-- Navbar -->
  <nav id="main-navbar" class="flex items-center justify-between px-6 py-4 bg-white shadow-lg sticky top-0 z-50 transition-transform duration-300">
    ...
    <div class="flex items-center space-x-6 justify-center flex-1">
        ...
        <a href="about" class="px-3 py-1 border border-gray-400 rounded bg-gray-200 font-semibold text-sm" aria-current="page">Tentang</a>
        <a href="rating" class="block px-3 py-2 rounded-md hover:bg-gray-100">Rating</a>
    </div>
    <div class="flex items-center space-x-3">
        <a href="masuk" class="text-gray-600 hover:text-gray-900 font-medium text-sm">Masuk</a>
        <a href="daftar" class="bg-black text-white rounded-full px-4 py-1 font-semibold text-sm hover:bg-gray-900 transition">Daftar</a>
    </div>
  </nav>

  <!-- Cara Kerja Section -->
  <section class="max-w-7xl mx-auto px-6 py-16 text-center">
    <h2 class="text-3xl font-semibold mb-2">Cara Kerja</h2>
    <p class="text-gray-500 mb-12">Proses rental sepeda yang mudah dan cepat dalam 4 langkah sederhana</p>
