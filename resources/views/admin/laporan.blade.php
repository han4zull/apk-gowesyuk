...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.laporan.export') }}" 
       class="flex items-center gap-2 bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-800 shadow">
        <i class="fa fa-file-export"></i> Export Data Laporan
    </a>
</div>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-col">
                                    <span class="font-semibold flex items-center">
                                        <i class="fa fa-user mr-2 text-gray-500"></i> {{ $laporan->customer->name }}
                                    </span>
                                    <span class="text-gray-500 text-sm">{{ $laporan->customer->phone }}</span>
                                </div>
                            </td>
